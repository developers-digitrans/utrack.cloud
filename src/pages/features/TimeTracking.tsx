          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-xl dark:text-gray-300 text-gray-600 mb-8">
                Track time spent on tasks and projects with precision to improve
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1508962914676-134849a727f0?q=80&w=800&auto=format&fit=crop"
                alt="Time Tracking"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="dark:text-gray-300 text-gray-600 mb-4">
                Track time your way with manual entries, timers, or automatic
                tracking based on task status changes.
              </p>
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="dark:text-gray-200 text-gray-700">
                    Manual time entry with date selection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              <p className="dark:text-gray-300 text-gray-600 mb-4">
                Generate comprehensive reports to analyze time spent by project,
                team member, or task category.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            >
              ...
              <p className="dark:text-gray-300 text-gray-600 mb-4">
                Convert tracked time into billable hours and integrate with
                popular invoicing and accounting software.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="dark:text-gray-200 text-gray-700">
                    Different billing rates by project or team member
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
              ...
              <p className="dark:text-gray-300 text-gray-600 mb-4">
                Track billable hours with precision to ensure accurate client
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
              ...
              <p className="dark:text-gray-300 text-gray-600 mb-4">
                Understand how time is spent across projects and teams to
                optimize resource allocation and improve productivity.
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto">
              Join thousands of professionals who use utrack to optimize their
